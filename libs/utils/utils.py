...
# Use this code for performace testing
    # def _prepare_message(self, bucket, key):
    #     destination_key = self.destination_prefix + str(uuid.uuid4()) + '.jpeg'
    #     message = {
